module ApplicationHelper
  ...
  def display_address(object)
    ...
    model = model_checker(object)
    if model == "user"
      return object.postal_address unless object.postal_address.match(rex)
      return object.postal_address.match(rex)[1,2].join
    elsif model == "ferret"
      return object.user.postal_address unless object.user.postal_address.match(rex)
